        ...
        <div className='bg-off-black py-12 sm:py-16 md:py-20 lg:py-24 xl:pt-[180px] xl:pb-[186px] mt-[-1px] overflow-hidden'>
            <div className="container mx-auto px-3 xl:max-w-[1164px] relative">
                <div className="grid grid-cols-1 lg:grid-cols-2 relative ">
                    <img className='lg:absolute relative w-[350px] h-[400px] md:w-[400px] md:h-[500px] mx-auto lg:w-[600px] lg:h-[800px] xl:w-[880px] xl:h-[1071px] object-cover lg:left-0 xl:left-[-10%] lg:bottom-[-60%] xl:bottom-[-90%] -mb-14 lg:mb-0' src={CartoonGirl} alt="girl-image" />
